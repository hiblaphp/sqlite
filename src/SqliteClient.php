...
use Hibla\Sql\Exceptions\NotInitializedException;
...
final class SqliteClient implements SqlClientInterface
{
    ...
    public function prepare(string $sql): PromiseInterface
    {
        ...
        /** @var PromiseInterface<ManagedPreparedStatement> */
    ...
    public function query(string $sql, array $params = []): PromiseInterface
    {
        ...
        /** @var PromiseInterface<SqliteResult> */
        return Promise::propagateCancellation($promise);
    }
    ...
    public function stream(string $sql, array $params = [], int $bufferSize = 100): PromiseInterface
    {
        ...
        /** @var PromiseInterface<RowStreamInterface> */
        return Promise::propagateCancellation($promise);
    }
